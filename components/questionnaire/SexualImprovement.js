...
const SexualImprovement = ({ register, errors, prevStep, nextStep }) => {
    return (
        <div className='bg-white shadow-box-xs p-5 md:py-9 md:px-12 rounded-lg'>
            <div className="space-y-[10px]">
                <span className="text-text text-sm font-medium">Are you seeking treatment for improved sexual activity</span>
                <div className='flex gap-2 mt-[10px] mb-6'>
                    <div className="relative inline-flex">
                        <input
                            ...
                            type="radio"
                            value="Yes"
                            {...register("simproved", { required: true })}
                ...
                {errors?.simproved && <p className='text-orange text-xs mt-2'>Please select one option</p>}
...
export default SexualImprovement