...
const MedicalProblems = ({ register, errors, prevStep, nextStep }) => {
    return (
        <div className='bg-white shadow-box-xs p-5 md:py-9 md:px-12 rounded-lg'>
            <div className="space-y-[10px]">

                <div>
                    <label htmlFor="otherMedicalProb" className="block text-sm font-medium text-text">
                        Please list all other medical problems
                    </label>
                    <div className="mt-[10px]">
                        <textarea id="otherMedicalProb"
                            name="otherMedicalProb"
                            type="text"
                            {...register("otherMedicalProb", { required: true })}
                        ...
                        {errors?.otherMedicalProb && <p className='text-orange text-xs mt-2'>Field is required</p>}
                    </div>
                </div>
